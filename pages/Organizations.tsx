        ...
        <section className="text-center max-w-5xl mx-auto mb-24">
            <Reveal>
                ...
                <div className="flex justify-center gap-6">
                    ...
                    <button className="border-2 border-[#3F4E3A] text-[#3F4E3A] px-10 py-4 rounded-full font-bold text-xl hover:bg-brand-light transition-colors">Partner with Us</button>
                </div>
            </Reveal>
        </section>
